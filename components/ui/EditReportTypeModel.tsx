...
interface EditReportTypeModelProps {
  reportTypeId: any;
  reportType: any;
  lang: string;
  dictionary: any;
...
const EditReportTypeModel: FC<EditReportTypeModelProps> = ({
  reportTypeId,
  reportType,
  lang,
  dictionary,
    ...
    if (!context?.jwt) {
      ...
      Takhnik.reportTypes
        ...
        .then((res: any) => {
          ...
          toast(dictionary['notify'].report_type_updated_ok, {
            hideProgressBar: true,
            autoClose: 2000,
            type: "success",
          });
...
export default EditReportTypeModel;
