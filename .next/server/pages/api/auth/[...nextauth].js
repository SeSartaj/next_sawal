...
var navigation = __webpack_require__(79771);
;// CONCATENATED MODULE: ./components/utils/ErrorMessage.ts
        ...
        credentials_default()({
            ...
            async authorize (credentials, req) {
                ...
                api.auth.signin({
                    ...
                    api.users.retrieve(res.data.id).then((res)=>{
                        user = res.data;
                    }).catch((error)=>{
                        console.error(getErrorMessage(error));
                        (0,external_react_toastify_namespaceObject.toast)(getErrorMessage(error), {
...
var __webpack_exports__ = __webpack_require__.X(0, [9775,2347], () => (__webpack_exec__(87981)));
